...
4. **Creating a Job to track pre-quote work** (site surveys, utility checks, feasibility reviews). Use `PreJobTask` on the `FlowGroup` instead. Jobs exist **only** after activation of a signed quote.
