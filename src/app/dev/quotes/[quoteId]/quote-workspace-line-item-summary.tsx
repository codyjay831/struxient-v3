...
export function QuoteWorkspaceLineItemSummary({ versionNumber, summary }: Props) {
  ...
  if (lineItemCount === 0) {
    return (
      <section className="mb-6 rounded-lg border border-dashed border-zinc-800 bg-zinc-950/20 p-4">
        <h2 className="text-[11px] font-semibold uppercase tracking-wider text-zinc-500">Scope summary</h2>
        <div className="mt-3 text-center py-2">
          <p className="text-sm text-zinc-400">No line items added yet</p>
          <p className="mt-1 text-[11px] text-zinc-500">
            This version (v{versionNumber}) is currently empty.
          </p>
        </div>
      </section>
    );
