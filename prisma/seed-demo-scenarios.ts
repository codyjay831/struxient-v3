...
const PACKET_SPECS: PacketSpec[] = [
  {
    ...
    lines: [
      ...
      },
      {
        ...
        sortOrder: 3,
        targetNodeKey: "node-commissioning",
        taskKind: "COMMISSION",
    ...
    lines: [
      {
        ...
        sortOrder: 0,
        targetNodeKey: "node-charger-install",
        taskKind: "INSTALL",
